"""
Django settings for CookSphere project.
...
INSTALLED_APPS = [
    ...
    'social',  # Add your social app here
]

# Additions for Django Allauth
INSTALLED_APPS += [
...
# Allauth settings for username/password signup only
ACCOUNT_EMAIL_REQUIRED = False
ACCOUNT_USERNAME_REQUIRED = True
ACCOUNT_AUTHENTICATION_METHOD = 'username'
ACCOUNT_EMAIL_VERIFICATION = 'none'

# Use local file storage for media
...
WSGI_APPLICATION = 'CookSphere.wsgi.application'
